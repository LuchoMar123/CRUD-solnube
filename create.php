...
<body background="fondo.jpg">
    ...
    if (isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `personal` (`nombre`, `apellido`, `telefono`, `direccion`, `sexo`) values ('$nombre','$apellido','$telefono','$direccion','$sexo')";
        ...
        if ($resultado == TRUE){
            ...
            echo "Ha ocurrido un problema al registrar el personal" . $sql . "<br>" . $conexion->error;
        }
